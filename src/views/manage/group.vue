                            ...
                            <el-scrollbar>
                                <div v-for="chat in chats" :key="chat.group_id" class="chat-item"  @click="openGroup(chat)" :class="active==chat.group_id ? 'active' : ''">
                                    ...
                                    <div class="chat-content">
                                        ...
                                        <p class="chat-message c-999" style="display: flex;"> 
                                            
                                            <span style=" width: 50%;">创建人：{{ chat.owner_id_info.realname }}</span>
                                            <span style="width: 50%;color: #F56C6C; text-align: center;">{{ chat.is_public==1?'公开福利群':'' }}</span>
                                        </p>
                                    </div>
                                    <div class="chat-time">
                                        {{ chat.reate_time }}
